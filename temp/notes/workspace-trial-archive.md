# WORKSPACE.md — trial archive

The sections cut from `WORKSPACE.md` on 2026-08-20, verbatim and in their original order. They
record the Forward Deployed Engineer trial: the plan of record and its revisions, the Phase 3
testing protocol, the findings, the robot-day runbook, the team direction ledger, the learning
log, and every dated handoff from Jul 19 to Jul 22. Section numbers are the originals.

Anything here that was still true on 2026-08-20 was carried into the live `WORKSPACE.md`.
