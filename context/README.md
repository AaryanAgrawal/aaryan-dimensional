...
- `ESTOP.md`, `ESTOP-PRD.md`, `ESTOP-TECHSPEC.md` - the e-stop module: working context, the PRD
  (published as a Linear project) and the tech spec (published as dimos issue 3621).
